<h1 class="titleInHeader">سربازخانه <span class="level">سطح <?php echo $village->resarray['f'.$id]; ?></span></h1>
<div id="build" class="gid19">
<div class="build_desc">
<a href="#" onClick="return Travian.Game.iPopup(19,4);" class="build_logo">
	<img class="building big white g19" src="img/x.gif" alt="سربازخانه" title="سربازخانه" />
</a>
در سربازخانه پیاده نظام ها تربیت می شوند. هر قدر سطح آن بالا باشد، زمان مورد نیاز برای تربیت آنها نیز کمتر خواهد بود.</div>
<?php
include("upgrade.tpl");
?>
<div class="clear"></div>
