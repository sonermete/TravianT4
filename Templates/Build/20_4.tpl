    ...
    echo "<div class=\"action first\">
					...
					<div class=\"details\">
						<div class=\"tit\">
							...
							<span class=\"furtherInfo\">(فعلی: ".$village->unitarray['u'.$i].")</span>
						</div>
                        <div class=\"showCosts\">
                        <span class=\"resources r1\"><img class=\"r1\" src=\"img/x.gif\" alt=\"چوب\">".${'u'.$i}['wood']."</span>
                        <span class=\"resources r2\"><img class=\"r2\" src=\"img/x.gif\" alt=\"خشت\">".${'u'.$i}['clay']."</span>
                        <span class=\"resources r3\"><img class=\"r3\" src=\"img/x.gif\" alt=\"آهن\">".${'u'.$i}['iron']."</span>
                        <span class=\"resources r4\"><img class=\"r4\" src=\"img/x.gif\" alt=\"گندم\">".${'u'.$i}['crop']."</span>
                        <span class=\"resources r5\"><img class=\"r5\" src=\"img/x.gif\" alt=\"مصرف گندم\">".${'u'.$i}['pop']."</span>
                        <div class=\"clear\"></div>
						...
						echo "</span><div class=\"clear\"></div></div><span class=\"value\">تعداد</span>
...
if($success == 0) {
	echo "<tr><td colspan=\"3\"><div class=\"none\"><center>برای آموزش سربازان اول از دارالفنون تحقیق کنید.</center></div></td></tr>";
}
?>